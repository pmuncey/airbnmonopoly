class RegionsController < ApplicationController
  def index
    ...
    @regions = @q.result(:distinct => true).includes(:properties).page(params[:page]).per(10)
  ...
  def create
    ...
    @region.city = params[:city]
    @region.neighborhood = params[:neighborhood]
    @region.latitude = params[:latitude]
    @region.longitude = params[:longitude]
